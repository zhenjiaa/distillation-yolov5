...
from distill_utils.loss import ComputeLoss,compute_sup_loss,compute_sup_loss_2
...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        model = dist_model(opt.cfg, ch=3, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
    with torch_distributed_zero_first(rank):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss_type', type=int, default=0, help='which loss to use')
